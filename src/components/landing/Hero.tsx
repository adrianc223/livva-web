    ...
    >
      ...
      <div className="relative z-[1] mx-auto flex w-full max-w-[1100px] flex-col items-center tablet:grid tablet:grid-cols-2 tablet:items-center tablet:gap-16">
        <div className="flex flex-col items-center tablet:items-start">
          {/* Small centered mark below tablet — the header still carries its own logo there. */}
          <div className="mb-10 flex items-center gap-2.5 text-[19px] font-black tablet:hidden">
            <Logo variant="dark" className="h-8 w-auto" /> livva
          </div>
          {/* Large mark at tablet+, replacing the header's (hidden there — see Header.tsx) so
              the brand mark appears exactly once on a wide viewport instead of twice. */}
